  ...
  const teamMembers = [
    {
      ...
      bio: "Amit is CTO and co-founder at Synapsis Medical Technologies. Leading AI research and development with 15+ years in machine learning and healthcare technology innovation.",
    ...
    },
    {
      ...
      linkedin: "https://linkedin.com/in/preetam",
      avatar: "/placeholder.svg"
    },
    {
      name: "Wasim",
    ...
    },
    {
      ...
      bio: "Harsh oversees operations and business development at Synapsis Medical. With 12+ years in healthcare operations, he ensures seamless execution of our innovative solutions.",
    ...
    },
    {
      ...
      bio: "Bala manages financial strategy and investor relations. Former Goldman Sachs executive with extensive experience in healthcare technology funding and growth strategies.",
      linkedin: "https://linkedin.com/in/bala",
      avatar: "/placeholder.svg"
    }
  ];
  ...
  const boardMembers = [
    {
      name: "Amit",
      role: "Chairman",
      bio: "Amit is CEO, co-founder and Chairman of the Board at Synapsis Medical Technologies. Before Synapsis, he founded Contrast, a software design consultancy, and was a UX Designer at Exceptional.",
      linkedin: "https://linkedin.com/in/amit",
      avatar: "/placeholder.svg"
    },
    {
      name: "Preetam",
      role: "Board Member",
      bio: "Preetam co-founded Intercom and leads the R&D team, including Product, Engineering, and Design. Previously, he co-founded Exceptional and was a UX Designer at Contrast.",
      linkedin: "https://linkedin.com/in/preetam",
      avatar: "/placeholder.svg"
    },
    {
      name: "Wasim",
      role: "Board Member",
      bio: "Wasim was the Chief Revenue Officer at Atlassian from 2020 to 2023, where he ran the marketing, sales, and support organizations driving significant growth.",
      linkedin: "https://linkedin.com/in/wasim",
      avatar: "/placeholder.svg"
    },
    {
      ...
      bio: "Harsh is a seasoned healthcare executive with 20+ years of experience in medical device innovation. Former VP of Strategy at Medtronic, he brings deep industry expertise.",
      linkedin: "https://linkedin.com/in/harsh",
      avatar: "/placeholder.svg"
    },
    {
      name: "Bala",
      role: "Independent Director",
      bio: "Bala is a technology veteran and former CTO of major healthcare systems. He specializes in AI implementation and regulatory compliance in medical technology.",
      linkedin: "https://linkedin.com/in/bala",
      avatar: "/placeholder.svg"
    }
  ];
    ...
    <div className="pt-24 mt-8 md:mt-30 mb-24 pb-20 bg-white">
      ...
      <section className="px-4 mb-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div ref={teamRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-8">
            {/* First 3 members */}
            {teamMembers.slice(0, 3).map((member) => 
              renderMemberCard(member, "team-member")
            )}
      ...
      <section className="px-4 mb-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div ref={boardRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-8">
            {/* First 3 members */}
            {boardMembers.slice(0, 3).map((member) => 
              renderMemberCard(member, "board-member")
            )}
